...
object AppStyles {
    val textTitle = TextStyle(color = Green500, fontSize = 22.sp, fontWeight = FontWeight(700))
    val textSubtitle = TextStyle(color = Color.Black, fontSize = 20.sp, fontWeight = FontWeight(500))
